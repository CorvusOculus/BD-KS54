...
{
    public partial class tkan : Form
    {
        public tkan(int userrr)
        {
            InitializeComponent();
            user = userrr;
        }
        ...
        private void Form5_Load(object sender, EventArgs e)
        {
            ...
            this.тканьTableAdapter1.Fill(this.ilyaPapkaDataSet.Ткань);
            // TODO: данная строка кода позволяет загрузить данные в таблицу "dataSet1.Ткань". При необходимости она может быть перемещена или удалена.
            this.тканьTableAdapter1.Fill(this.ilyaPapkaDataSet.Ткань);
            if (user == 0)
            {
